...
Which shows us pretty summarily that the two things we have to control are the number of elements ($M$ and $N$) and the spacing of those elements ($d_x$ and $d_y$). So let's understand how changing each of these changes the properties of our phased array antenna. 
